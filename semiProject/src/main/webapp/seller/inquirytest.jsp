...
<form id='action'>
	<table>
		<tr>
			...
			<td> <input type='text' id='title' name='title' value='${post.ih_title }' disabled></td>
		</tr>
		<tr>
			<td width="20%" align="center"> 내용 </td>
			<td>
				<textarea rows="20" cols="60" id='content' name='content' disabled>${post.ih_question}</textarea>
			</td>
		</tr>
		<tr>
			<td width="20%" align="center"> 작성자 </td> 
			<td><input type='text' id='id' name='id' value='${post.mi_id }' disabled></td> 
		</tr>
