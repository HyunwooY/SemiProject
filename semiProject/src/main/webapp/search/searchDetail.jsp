...
<!-- 상품이미지 출력 -->
	...
	<div id="anno">
		...
		<h3>[교환 및 반품 주소]</h3><br>
		<span>CJ대한통운 택배사 이용시 : 경기도 김포시 전호리 748 CJ대한통운 김포봉수 집배점 (유먼트)<br></span>
		<span>타 택배사 이용시 : 인천광역시 서구 봉수대로 151 패스트박스 (유먼트)</span><br><br>
		<h3>[교환 절차 안내]</h3><br>
		<h3>1. 교환 신청하기 </h3><br>
		<span>- 모든 교환 및 반품은 유먼트를 통해 휴일포함 7일 이내 사이트내의 QnA 게시판을 통해 교환</span><br>
		...
		<span>- 유먼트에서는 택배기사님 직접 픽업신청 서비스를 제공하지 않고 있습니다.</span><br>
		<span>- 보내주신 제품은 평균 2~3일 이내 도착하며, 확인 후 교환제품 발송까지는 영업일 기준 최</span><br>
		<span>대 3-7일이 소요될 수 있습니다.</span><br><br>
		<h3>3. 교환완료 제품 수령하기 </h3><br>
		<span>- 교환완료되어 고객님이 다시 받으실 제품의 택배비는 무통장입금으로 아래 계좌로 3,000</span><br>
		<span>원을 입금해주시면 됩니다.</span><br>
		<span>- 교환 택배비 입금 확인이 되어야 교환 제품이 발송되오니 확인 부탁드립니다.</span><br><br>
		<h3>[반품 절차 안내]</h3><br>
		<h3>1. 반품 신청하기</h3><br>
		<span>- 모든 교환 및 반품은 유먼트를 통해 휴일포함 7일 이내 사이트내 QnA게시판을 통해 교환 및</span><br>
		...
		<span>합니다.</span><br><br>
		<span>- 유먼트에서는 택배기사님 직접 픽업신청 서비스를 제공하지 않고 있습니다.</span><br><br>
